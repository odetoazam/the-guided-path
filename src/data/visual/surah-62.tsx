...
const SURAH_DATA = {
  ...
  diagrams: {
    ...
    deductiveFunnel: {
      ...
      layers: [
        { depth: 1, label: "Received", ayah: "2", arabic: "يُزَكِّيهِمْ", desc: "The Prophet purifies them (tazkiyah). Remembrance is first something done to the community — received, not yet generated by them.", color: "#4ecdc4" },
