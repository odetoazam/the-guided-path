...
const SURAH_DATA = {
  ...
  heartVerse: {
    arabic: "مَا يَكُونُ مِن نَّجْوَىٰ ثَلَاثَةٍ إِلَّا هُوَ رَابِعُهُمْ",
    ayahRef: "58:7",
  ...
  diagrams: {
    ...
    deductiveFunnel: {
      ...
      layers: [
        ...
        { depth: 3, label: "Community Counsel", ayah: "7", arabic: "إِلَّا هُوَ رَابِعُهُمْ", desc: "Every private conversation under divine surveillance. The surah moves from one household to every gathering. No space elevated above God's hearing.", color: "#C9A84C" },
