...
export const DIVINE_NAMES: DivineName[] = [
  ...
  { number: 30, arabic: 'ٱللَّطِيف', translit: 'Al-Latif', english: 'The Subtle', root: 'ل-ط-ف', wordCount: 7 },
  ...
  { number: 35, arabic: 'ٱلشَّكُور', translit: 'Ash-Shakur', english: 'The Appreciative', root: 'ش-ك-ر', wordCount: 12 },
  ...
  { number: 38, arabic: 'ٱلْحَفِيظ', translit: 'Al-Hafiz', english: 'The Preserver', root: 'ح-ف-ظ', wordCount: 12 },
  ...
  { number: 42, arabic: 'ٱلْكَرِيم', translit: 'Al-Karim', english: 'The Generous', root: 'ك-ر-م', wordCount: 30 },
  ...
  { number: 52, arabic: 'ٱلْوَكِيل', translit: 'Al-Wakil', english: 'The Disposer of Affairs', root: 'و-ك-ل', wordCount: 24 },
