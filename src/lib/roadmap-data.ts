...
export const ROADMAP = {
  ...
  shipped: [
    { title: 'Course 6 — Maryam: She Believed the Word. The uqnutī→qānitīn command-verdict bracket (3:43 → 66:12, her last verse in the Quran, masculine plural per al-Baghawī by name), the double iṣṭafāki, ar-Raḥmān 16× in her sūrah (double any other), and the sister-of-Hārūn polemic answered from Ṣaḥīḥ Muslim', date: 'Aug 2026' },
